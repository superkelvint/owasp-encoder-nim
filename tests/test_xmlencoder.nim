...
import xmlencoder                # Your xmlencoder.nim module
...
proc runModeTest(mode: XMLEncoderMode) =
  ...
  # --- Port of common builder chain from XMLEncoderTest.java ---
...
suite "XMLEncoder Tests":
  ...
  test "Mode: ATTRIBUTE":
    runModeTest(ATTRIBUTE)

  test "Mode: SINGLE_QUOTED_ATTRIBUTE":
    runModeTest(SINGLE_QUOTED_ATTRIBUTE)

  test "Mode: DOUBLE_QUOTED_ATTRIBUTE":
    runModeTest(DOUBLE_QUOTED_ATTRIBUTE)